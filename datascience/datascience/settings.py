...
SECRET_KEY = '9sfobdt$3yuib-%6y*m_9-(rlz!b-)e&4i2zrn&gbyi*z^d7=-'

debug_setting = os.getenv('DEBUG', 'true')
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True if debug_setting == 'true' else False
hosts_setting = os.getenv('ALLOWED_HOSTS', '*')
ALLOWED_HOSTS = [hosts_setting]
...
INSTALLED_APPS = [
    ...
    'smartpackage.apps.SmartpackageConfig',
]
